...
void tool_psa(const vdfastvector<const wchar_t*>& args, const vdfastvector<const wchar_t*>& switches) {
	...
	printf("Asuka: Assembling pixel shader (Direct3D): %ls -> %ls.\n", filename, args[1]);
	...
	fprintf(f, "// Pixel shader data auto-generated by Asuka from %ls. DO NOT EDIT!\n", VDFileSplitPath(filename));

	VDTextInputFile in(filename);
